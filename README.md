# Aimee module: benchmarks

This is the independent `benchmarks` source-ownership repository.

It builds `aimee-module-benchmarks` as a separate Go process for the
